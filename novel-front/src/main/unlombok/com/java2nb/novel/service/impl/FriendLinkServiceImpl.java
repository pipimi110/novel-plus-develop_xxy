...
public class FriendLinkServiceImpl implements FriendLinkService {
    ...
    public List<FriendLink> listIndexLink() {
        ...
        if (result == null || result.size() == 0) {
            SelectStatementProvider selectStatement = select(linkName, linkUrl).from(friendLink).where(isOpen, isEqualTo((byte) 1)).orderBy(sort).build().render(RenderingStrategies.MYBATIS3);
    ...
    public FriendLinkServiceImpl(final FriendLinkMapper friendLinkMapper, final CacheService cacheService) {
