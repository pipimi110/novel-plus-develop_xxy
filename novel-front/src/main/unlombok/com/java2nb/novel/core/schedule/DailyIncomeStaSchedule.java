...
public class DailyIncomeStaSchedule {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(DailyIncomeStaSchedule.class);
    ...
    @java.lang.SuppressWarnings("all")
    public DailyIncomeStaSchedule(final AuthorService authorService, final UserService userService, final BookService bookService) {
