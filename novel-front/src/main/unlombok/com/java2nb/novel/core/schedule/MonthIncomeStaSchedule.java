...
public class MonthIncomeStaSchedule {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(MonthIncomeStaSchedule.class);
        ...
        do {
            ...
            for (Author author : authors) {
                ...
                for (Book book : books) {
                    ...
                    BigDecimal monthIncomeShare = new BigDecimal(monthIncome).multiply(authorIncomeConfig.getShareProportion());
                    long preTaxIncome = monthIncomeShare.multiply(authorIncomeConfig.getExchangeProportion()).multiply(new BigDecimal(100)).longValue();
                    totalPreTaxIncome += preTaxIncome;
                    long afterTaxIncome = monthIncomeShare.multiply(authorIncomeConfig.getTaxRate()).multiply(authorIncomeConfig.getExchangeProportion()).multiply(new BigDecimal(100)).longValue();
    ...
    @java.lang.SuppressWarnings("all")
    public MonthIncomeStaSchedule(final AuthorService authorService, final BookService bookService, final AuthorIncomeProperties authorIncomeConfig) {
        this.authorService = authorService;
        this.bookService = bookService;
        this.authorIncomeConfig = authorIncomeConfig;
    }
}
