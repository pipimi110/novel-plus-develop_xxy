...
public class BookVisitAddListener {
   ...
   private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(BookVisitAddListener.class);
   ...
   @java.lang.SuppressWarnings("all")
   public BookVisitAddListener(final BookService bookService, final CacheService cacheService, final SearchService searchService) {
