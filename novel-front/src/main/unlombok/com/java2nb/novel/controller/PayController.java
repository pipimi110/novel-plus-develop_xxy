...
public class PayController extends BaseController {
	...
	public void aliPay(Integer payAmount, HttpServletRequest request, HttpServletResponse httpResponse) {
		try {
			...
			if (userDetails == null) {
				...
				//填充业务参数
				alipayRequest.setBizContent("{    \"out_trade_no\":\"" + outTradeNo + "\",    \"product_code\":\"FAST_INSTANT_TRADE_PAY\",    \"total_amount\":" + payAmount + ",    \"subject\":\"小说精品屋-plus\"  }");
				//调用SDK生成表单
	...
	*/
	...
	@java.lang.SuppressWarnings("all")
	public PayController(final AlipayProperties alipayConfig, final OrderService orderService) {
