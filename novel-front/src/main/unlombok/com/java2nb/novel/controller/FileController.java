...
public class FileController {
    ...
    RestResult<String> upload(@RequestParam("file") MultipartFile file) {
        try {
            ...
            String savePath = Constants.LOCAL_PIC_PREFIX + DateUtils.formatDate(currentDate, "yyyy") + "/" + DateUtils.formatDate(currentDate, "MM") + "/" + DateUtils.formatDate(currentDate, "dd");
    ...
    @java.lang.SuppressWarnings("all")
    public FileController(final CacheService cacheService) {
