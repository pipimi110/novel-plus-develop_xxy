...
public class PageController extends BaseController {
    ...
    @java.lang.SuppressWarnings("all")
    public PageController(final BookService bookService, final NewsService newsService, final AuthorService authorService, final UserService userService, final ThreadPoolExecutor threadPoolExecutor, final Map<String, BookContentService> bookContentServiceMap) {
        this.bookService = bookService;
        this.newsService = newsService;
        this.authorService = authorService;
        this.userService = userService;
        this.threadPoolExecutor = threadPoolExecutor;
        this.bookContentServiceMap = bookContentServiceMap;
    }
}
